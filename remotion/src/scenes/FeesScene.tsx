...
export const FeesScene = () => {
  ...
  const features = ["Track every rupee", "Malayalam reminders", "Receipts & reports", "Partial payments"];
  ...
  return (
    <AbsoluteFill style={{ fontFamily, padding: 50 }}>
      ...
      <div style={{
        ...
        borderRadius: 24, overflow: "hidden", boxShadow: "0 30px 80px rgba(0,0,0,0.5)",
        width: 900, height: 700, alignSelf: "center",
      }}>
        <Img src={staticFile("images/feature-fees.jpg")} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
      </div>
