...
export const PortalScene = () => {
  ...
  const features = ["Grades & report cards", "Attendance calendar", "Fee status", "Homework & announcements"];
  ...
  return (
    <AbsoluteFill style={{ fontFamily, padding: 50 }}>
      ...
      <div style={{
        ...
        borderRadius: 24, overflow: "hidden", boxShadow: "0 30px 80px rgba(59,130,246,0.4)",
        width: 900, height: 700, alignSelf: "center",
      }}>
        <Img src={staticFile("images/feature-portal.jpg")} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
      </div>
